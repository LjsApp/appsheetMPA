...
export default function PODetail() {
  ...
  return (
    <div className="space-y-5 pb-20">
      ...
      {/* PO Document — structure same as QuotationDetail */}
      <div className="bg-white rounded-2xl border border-gray-200 shadow-lg max-w-[860px] mx-auto text-[12pt]" id="po-doc">
                ...
                <div className="px-10 py-6">
                  ...
                  <div className="grid grid-cols-2 gap-6 mb-5 text-[12pt] leading-snug">
                    ...
                    <div className="space-y-0.5">
                      ...
                      <div className="flex"><span className="text-gray-700 w-24 shrink-0">Ref Date</span><span className="text-gray-700 mr-2">:</span><span className="text-gray-800">-</span></div>
                    </div>
                  </div>
                  ...
                  <div className="break-inside-avoid mb-5 text-[12pt]">
                    ...
                    <div className="grid grid-cols-[120px_10px_1fr] gap-y-1 text-gray-800">
                      <div className="font-medium">Due Date</div><div>:</div><div>{dueDate}</div>
